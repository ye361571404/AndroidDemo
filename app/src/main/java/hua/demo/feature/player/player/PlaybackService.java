package hua.demo.feature.player.player;
...
import hua.demo.feature.player.utils.AlbumUtils;
...
public class PlaybackService extends Service implements IPlayback, IPlayback.Callback {
    ...
    private static final String ACTION_PLAY_TOGGLE = "hua.demo.ACTION.PLAY_TOGGLE";
    private static final String ACTION_PLAY_LAST = "hua.demo.ACTION.PLAY_LAST";
    private static final String ACTION_PLAY_NEXT = "hua.demo.ACTION.PLAY_NEXT";
    private static final String ACTION_STOP_SERVICE = "hua.demo.ACTION.STOP_SERVICE";
    ...
    private void showNotification() {
        ...
        PendingIntent contentIntent = PendingIntent.getActivity(this, 0, new Intent(this, MusicPlayerActivity.class), 0);
