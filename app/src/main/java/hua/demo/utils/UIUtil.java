...
public class UIUtil {
	...
	public static Context getContext(){
		return HuaApplication.getContext();
	}

	public static int getMainThreadId(){
		return HuaApplication.getMainThreadId();
	}
	
	public static Thread getMainThread(){
		return HuaApplication.getMainThread();
	}
	
	public static Handler getHandler(){
		return HuaApplication.getHandler();
	}
	...
	public static int getDimens(int id) {
		...
		return UIUtil.getContext().getResources().getDimensionPixelSize(id);
	}
